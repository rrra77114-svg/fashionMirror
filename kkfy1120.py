...
class FashionComplimentSystem:
    def __init__(self):
        ...
        self.detection_cooldown = 30  # 检测冷却时间(秒)
    ...
    2. 整体的时尚感和个人气质
    3. 具体的穿搭亮点
    要求语言生动有趣，充满赞美之情，长度在50-80字左右,并结合以下信息
    天气是{self.get_current_weather()}
    现在的地点是{self.get_location()}
    现在的时间是{self.get_time()}
    人物的心情是{self.emotion_recognition(self.capture_image())}
"""
        return prompt
